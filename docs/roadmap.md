...
The owner selected immutable mode by default and supported writable mode in
[decision 0004](decisions/0004-os-operating-modes.md). Mode switching and
...
retains the evidence and limitations. The disposable
